...
const Games = {
    template: `
    <div>
        <header class="sr-only">All games</header>
        <main>
            <div class="container">
                ...
                <template v-if="this.$store.state.authenticated && !isUserInGame">
                    <button type="button" class="btn btn-primary btn-botton-right btn-circle btn-xl animated tada" @click.prevent="newGame" aria-label="Create new game"><i class="fas fa-plus"></i></button>
